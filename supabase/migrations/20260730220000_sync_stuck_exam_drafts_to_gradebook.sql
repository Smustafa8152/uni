-- Allow stuck EX_DRF attempts that already have a score / submitted_at to sync into gradebook.
-- (Previously only EX_SUB/EX_GRD or submission_data.submitted/autoGrade were accepted.)
